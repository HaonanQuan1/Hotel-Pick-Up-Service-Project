...
public class CustomerProfileJPanel extends javax.swing.JPanel {
     ...
     */
    public CustomerProfileJPanel(EcoSystem system, JPanel container, CustomerAccount account, JFrame frame, Role accessRole, Network net) {
        initComponents();
        this.system = system;
    ...
    private void setInfo() {
       ...
       // addressTextField.setText(customer());
    ...
    private void setFieldsEditable(boolean b) {
        usernameTextField1.setEditable(b);
        usernameTextField1.setEnabled(true);
    ...
    private void initComponents() {
        ...
        orderTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order#", "Date", "Status", "Merchant", "Amount", "Review"
            }
        ) {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(detailPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 316, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        }
    ...
    private void orderTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_orderTableMouseClicked
        ...
        if (index >= 0) {
            ...
            Model shop = (Model) orderTable.getValueAt(index, 3);
            OrderDetailJPanel panel = new OrderDetailJPanel(system, order, shop, this,net);
